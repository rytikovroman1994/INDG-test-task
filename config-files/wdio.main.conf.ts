...
import { config as develop } from './wdio.develop.conf';
import { config as docker } from './wdio.docker.conf';
import { config as browserstack } from './wdio.browserstack.conf';
